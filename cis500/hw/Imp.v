...
(** One very basic tactical is written [;].  If [T], [T1], ..., [Tn]
    are tactics, then
[[
      T; [T1 | T2 | ... | Tn] 
]]
...
(** Another simple tactical is [try]: If [T] is a tactic, then [try T]
...
Proof.
  ...
  (* The remaining cases -- ANum and APlus -- are more interesting... *)
  Case "ANum". reflexivity.
  Case "APlus". 
    destruct e1; 
      (* Again, most cases follow directly by the IH *)
      try (simpl; simpl in IHe1; rewrite IHe1; rewrite IHe2; reflexivity).
    (* The interesting case, on which the [try...] does nothing, is 
...
(** Here is a shorter proof making more aggressive use of
    tacticals: *)
...
Proof.
  ...
  Case "<-".
      ...
      SCase "BAnd"; apply IHe1. reflexivity. apply IHe2. reflexivity.
Qed.
(** [] *)
...
(** One might wonder whether all this work with poking at states and
    ...
    exactly the topic of the upcoming [Hoare.v] chapter! *)
